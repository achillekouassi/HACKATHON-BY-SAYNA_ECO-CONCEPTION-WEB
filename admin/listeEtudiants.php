    ...
    if(isset($_POST['action']) && $_POST['action'] === 'insert') {
        ...
        try {
            ...
            if ($existingUser) {
                ...
                echo "<script>showSuccessMessageAndRedirect('Compte etudiant Créé avec succès.', 'listeEtudiants.php', 3000);</script>";
            }
...
if(isset($_GET['action']) && $_GET['action'] === 'delete') {
    if(isset($_GET['userId'])) {
        ...
        try {
            ...
            // Rediriger vers la page de liste des etudiants
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if(isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        try {
            ...
            echo "<script>alert('Utilisateur modifié avec succès.'); window.location.href = 'listeEtudiants.php';</script>";
        } catch (PDOException $e) {
            echo "Erreur de connexion : " . $e->getMessage();
        }
    }
...
<td>
    ...
    <a href="?action=delete&userId=<?= $user['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet etudiant ?')"><i class='bx bxs-trash icon-large'></i> </a>
</td>
</tr>
<?php endforeach; ?>
</tbody>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Modifier Etudiant</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
